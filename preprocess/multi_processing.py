...
def gettweet():
    ...
    twitter_df = pd.DataFrame(columns = ["fesitival", "text", "hashtags", "year", "polarity", "score", "hashtags_polarity", "hashtags_score"])
        ...
        for year in years:
            ...
            for index in tqdm_notebook(tweet):
                ...
                for tag_one in tag_data:
                    ...
                    hashtag_polarity.append("")
                    hashtag_score.append(0)
                ...
                polarity = ""
                score = 0
                hashtags_polarity.append(hashtag_polarity)
                hashtags_score.append(hashtag_score)

                # 결과 합치기
                info_list = [fes, content, hashtags, year, sentiment, score, hashtags_polarity, hashtags_score]
                tweet_list.append(info_list)

                # 휴식 
                time.sleep(uniform(1,2))

            twitter_df = pd.DataFrame(tweet_list, columns = ["fesitival", "text", "hashtags", "year", "polarity", "score", "hashtags_polarity", "hashtags_score"]).append(twitter_df, ignore_index=True)
